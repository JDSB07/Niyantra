...
export function CountUp({ value, decimals = 0, suffix = '' }) {
  // Lightweight count-up without extra deps: framer-motion's animate() on a
  // plain number via useEffect would need more plumbing than this file
  // warrants, so this renders the value directly but animates its container.
  return (
    <motion.span
      key={value}

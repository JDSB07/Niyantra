    ...
    <div className="bg-slate-50 flex flex-col font-sans">
      ...
      <div className="bg-slate-100 border-b border-slate-200 px-4 md:px-8 py-1.5 flex flex-wrap items-center justify-between text-xs font-semibold text-slate-600">
        ...
        <div className="flex items-center gap-4 mt-2 sm:mt-0">
          <a href="#main-content" className="hover:text-navy transition focus:outline-none focus-visible:ring-2 focus-visible:ring-gold">{t('landing.skip')}</a>
          <div className="flex items-center gap-1 border-l border-r border-slate-300 px-3">
            <button onClick={() => setTextSize('14px')} className="px-1 hover:text-navy" aria-label="Decrease Text Size" title="Decrease Text Size">A-</button>
            <button onClick={() => setTextSize('16px')} className="px-1 hover:text-navy" aria-label="Normal Text Size" title="Normal Text Size">A</button>
            <button onClick={() => setTextSize('18px')} className="px-1 hover:text-navy" aria-label="Increase Text Size" title="Increase Text Size">A+</button>
          </div>
          <button onClick={toggleLanguage} aria-label="Toggle Language" className="font-bold text-navy hover:underline">
      ...
      <div className="bg-white px-4 md:px-8 py-4 flex flex-wrap items-center justify-between gap-6 shadow-sm relative z-20">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <h1 className="text-xl md:text-2xl font-bold text-navy tracking-tight leading-tight">{t('landing.title')}</h1>
      ...
      <nav aria-label="Main Navigation" className="bg-navy px-4 md:px-8 text-white sticky top-0 z-50 shadow-md">
      ...
      {/* Hero Section */}
      <div id="main-content" className="relative h-[80vh] min-h-[600px] bg-navy overflow-hidden focus:outline-none" tabIndex="-1">
        <div 
        ...
        <div className="relative z-10 p-8 md:p-16 max-w-3xl h-full flex flex-col justify-center">
          ...
          <div className="mt-8">
            <button 
              onClick={onLogin}
              className="bg-amber-500 hover:bg-amber-600 text-navy font-bold py-3 px-8 rounded shadow-lg text-lg transition-transform hover:scale-105 active:scale-95 flex items-center gap-2"
            >
      ...
      <section id="about" className="py-20 px-8 bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-3xl font-black text-navy uppercase tracking-widest mb-6 border-b-4 border-amber-400 inline-block pb-2">{t('landing.about_title')}</h3>
      ...
      <section id="divisions" className="py-20 px-8 bg-slate-50 border-b border-slate-200">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-3xl font-black text-navy uppercase tracking-widest mb-10 border-b-4 border-amber-400 inline-block pb-2">{t('landing.div_title')}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 border-2 border-slate-200 shadow-sm hover:border-navy hover:shadow-md transition-all text-center">
              <div className="h-16 w-16 bg-navy text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black">NR</div>
              <h4 className="font-bold text-slate-800">{t('landing.div_northern')}</h4>
            </div>
            <div className="bg-white p-6 border-2 border-slate-200 shadow-sm hover:border-navy hover:shadow-md transition-all text-center">
              <div className="h-16 w-16 bg-navy text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black">WR</div>
              <h4 className="font-bold text-slate-800">{t('landing.div_western')}</h4>
            </div>
            <div className="bg-white p-6 border-2 border-slate-200 shadow-sm hover:border-navy hover:shadow-md transition-all text-center">
              <div className="h-16 w-16 bg-navy text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black">ER</div>
              <h4 className="font-bold text-slate-800">{t('landing.div_eastern')}</h4>
            </div>
            <div className="bg-white p-6 border-2 border-slate-200 shadow-sm hover:border-navy hover:shadow-md transition-all text-center">
              <div className="h-16 w-16 bg-navy text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black">SR</div>
      ...
      <section id="services" className="py-20 px-8 bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-3xl font-black text-navy uppercase tracking-widest mb-10 border-b-4 border-amber-400 inline-block pb-2">{t('landing.serv_title')}</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-slate-50 border border-slate-200 flex flex-col items-start">
              <ShieldAlert size={48} className="text-navy mb-4" />
            ...
            <div className="p-8 bg-slate-50 border border-slate-200 flex flex-col items-start">
              <SplitSquareHorizontal size={48} className="text-navy mb-4" />
            ...
            <div className="p-8 bg-slate-50 border border-slate-200 flex flex-col items-start">
              <LineChart size={48} className="text-navy mb-4" />
      ...
      <section id="notifications" className="py-20 px-8 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-3xl font-black text-navy uppercase tracking-widest mb-10 border-b-4 border-amber-400 inline-block pb-2">{t('landing.notif_title')}</h3>
          <ul className="space-y-4">
            <li className="bg-white p-6 border-l-4 border-ir-maroon shadow-sm flex items-center justify-between">
      ...
      {/* Footer */}
      <footer className="bg-navy text-white text-center py-6 text-sm font-semibold border-t-4 border-ir-gold">
